 ...
 *   {city_slug} → ranchi / chandrapur  (URL mein use karo)
 ...
 *
 * INTERNAL LINKING EXAMPLE (City Intro textarea mein):
 *   <a href="/{city_slug}/laptop-motherboard-repair/">laptop motherboard repair</a>
 *   <a href="/{city_slug}/laptop-screen-replacement/">screen replacement</a>
 *   <a href="/{city_slug}/laptop-battery-replacement/">battery replacement</a>
 *   <a href="/{city_slug}/laptop-keyboard-replacement/">keyboard replacement</a>
 *
...
class Ezonecare_Placeholder {
    ...
    public static function get_replacements( $city_id, $city_data ) {
        ...
        $city_slug   = get_post_field( 'post_name', $city_id ); // e.g. ranchi, chandrapur
        ...
        return array(
            '{city}'      => $city_name,
            '{city_slug}' => $city_slug,  // v1.5.3: URL ke liye — e.g. /ranchi/ /chandrapur/
            '{center}'    => $center_name,
            '{area}'      => $area,
            '{landmark}'  => $landmark,
